...
body,*{font-family:Calibri,'Trebuchet MS',Arial,sans-serif;}
::-webkit-scrollbar{width:4px;height:4px;}
::-webkit-scrollbar-thumb{background:#d1d5db;border-radius:2px;}
.pos{color:#16a34a!important;}
.neg{color:#dc2626!important;}
.muted{color:#9ca3af!important;}
.card{background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:16px;box-shadow:0 1px 3px rgba(0,0,0,.05);}
...
tbody td{padding:8px 10px;border-bottom:1px solid #f3f4f6;font-size:13px;font-variant-numeric:tabular-nums;color:#374151;}
tbody tr:last-child td{border-bottom:none;}
tbody tr:hover td{background:#f9fafb;}
tfoot td{padding:8px 10px;font-size:13px;font-variant-numeric:tabular-nums;border-top:2px solid #e5e7eb;background:#fafafa;font-weight:700;}
